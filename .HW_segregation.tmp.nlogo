...
turtles-own [
  happy?           ; for each turtle, indicates whether at least similarity-wanted percent of
...
to update-turtles
  ask turtles [
    ...
    set happy? similar-nearby >= (similarity-wanted * total-nearby / 100)
    set shape "default" set size 1.3
  ]
end
...
Over time, the number of unhappy agents may decrease. But the neighborhood becomes more segregated, with clusters of orange agents and clusters of blue agents.
...
Try different values for SIMILARITY-WANTED and DENSITY. How does different values affect the percentage of unhappy agents? 
...
This is a modified model by Jose Magallanes, for a course activity.

The originalmodel in NetLogo library was created as part of the project: CONNECTED MATHEMATICS: MAKING SENSE OF COMPLEX PHENOMENA THROUGH BUILDING OBJECT-BASED PARALLEL MODELS (OBPML).  The project gratefully acknowledges the support of the National Science Foundation (Applications of Advanced Technologies Program) -- grant numbers RED #9552950 and REC #9632612.
...
<experiments>
  <experiment name="experiment" repetitions="100" runMetricsEveryStep="true">
    ...
    <steppedValueSet variable="similarity_Wanted" first="30" step="5" last="80"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
